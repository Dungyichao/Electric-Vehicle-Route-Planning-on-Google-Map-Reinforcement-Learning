...
(1) enter your start position: name of position or geocode (lat, lng)_
(2) enter your destination position: name of position or geocode (lat, lng)_
(3) enter the length of each step, higher but less accurate (ex: 1000m takes less time to train compare to 100m)_
(4) enter how many episode you want to train_
